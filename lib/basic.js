(function() {
  ...
  module.exports = Basic = (function(_super) {
    ...
    Basic.prototype.defaults = function() {
      var _envDebug, _ref, _ref1, _ref2;
      _envDebug = ((_ref = process.env) != null ? (_ref1 = _ref.debug) != null ? _ref1.split(",") : void 0 : void 0) || [];
      return {
        logging: {
          severity: (__indexOf.call(_envDebug, "_all") >= 0 || (_ref2 = this.constructor.name, __indexOf.call(_envDebug, _ref2) >= 0) ? "debug" : "warning"),
    ...
    */
    ...
    function Basic(options) {
      ...
      this._waitUntilReady = __bind(this._waitUntilReady, this);
    ...
    */
    ...
    Basic.prototype._waitUntilReady = function(method) {
      var _this = this;
      return function() {
        var args;
        args = arguments;
